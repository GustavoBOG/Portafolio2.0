  ...
  return (
    <section className="w-full min-h-[calc(100vh-80px)] bg-background py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:justify-end justify-center mb-12 space-y-4 sm:space-y-0 sm:space-x-[230px] text-center sm:text-left">
          <h2 className="text-text text-h1 font-roboto">PROYECTOS</h2>
          <span className="text-text text-h1 font-roboto">{projects.length}</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          {selectedProject ? (
            <div className="space-y-6">
              ...
              <p className="text-text text-h5 text-justify">{currentProject?.fullDescription}</p>
              ...
              <div className="flex gap-6 flex-wrap items-center justify-start mt-4">
                <a href={currentProject?.pageUrl} target="_blank" rel="noopener noreferrer">
